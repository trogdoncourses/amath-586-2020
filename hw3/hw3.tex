...
\title{\bf { AMATH 586 Spring 2020 \\ Homework 3 ---
Due May 8 on GitHub by 11pm} }
\maketitle
...
v(0) = \beta_3, \\
v'(0) = 0,\\
v''(0) = -\frac{(\beta_3 - \beta_1)(\beta_3-\beta_2)}{6}.$$  Write the equation as a system and compute the Jacobian.  For $\beta_1 =0, \beta_2 = 1, \beta_3 = 10$, based on an analysis of the Jacobian, suggest methods to solve the problem.
...
$\rho(D_x(\bar x)) < 1$, where $\rho(A)$ denotes the spectral radius of a
matrix.
